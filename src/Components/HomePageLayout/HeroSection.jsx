    ...
    return (
        <section className='py-10 lg:py-20 bg-[#211F1F]'>
            <div className='flex flex-col-reverse md:flex-row gap-5 lg:gap-10 rounded-lg items-center justify-between mx-auto w-11/12 md:w-10/12 max-w-7xl'>
                <div className='text-center md:text-start lg:py-10 md:mt-10 text-white'>
                    ...
                    <Link to='/food-details'><button className='btn btn-accent btn-sm lg:btn-md text-white'>Explore Our Menu</button></Link>
                </div>
