...
const OrderCard = ({ orderData, allOrders, setAllOrders }) => {
    ...
    return (
        <div className='border border-secondary p-5 w-full mx-auto rounded-lg flex flex-col md:flex-row lg:flex-col xl:flex-row items-center gap-4 shadow-md'>
            <div className='w-full md:flex-2 lg:flex-5'>
                <img src={foodImageURL} alt={foodName} className='mx-auto rounded-xl w-full' />
            </div>
            <div className='w-full flex-3 lg:flex-7'>
